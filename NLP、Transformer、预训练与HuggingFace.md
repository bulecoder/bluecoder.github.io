...
#### 前馈神经网络层（[FFN的升维降维视频地址](https://www.bilibili.com/video/BV1oyoEBWEsn/?spm_id_from=333.1387.homepage.video_card.click&vd_source=d3285a2ba86bc368a3901aac90d388ea)）
...
- 模型结构，BERT基于标准的 Transformer 编码器构建。
    ...
    Position Embedding：表示 token 在序列中的位置，为可学习向量（BERT的位置编码和Transformer的位置编码不一样，是一个可学习的矩阵，最终的输入由位置嵌入、词嵌入和段落嵌入三者相加）；  
